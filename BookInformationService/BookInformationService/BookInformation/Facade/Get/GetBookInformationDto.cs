...
public class GetBookInformationDto
{
    /// <summary>
    ...
    public static implicit operator GetBookInformationDto(BookInformationModel bookInformationModel)
    {
        ...
        return new GetBookInformationDto
        {
